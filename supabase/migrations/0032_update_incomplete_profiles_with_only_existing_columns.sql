-- Update incomplete seller profiles with only verified existing columns
UPDATE profiles 
SET 
  ...
  store_opening_hours = COALESCE(store_opening_hours, 'Seg-Sex: 8h-18h'),
...
WHERE 
  ...
  AND (
    ...
    OR store_opening_hours IS NULL 
