-- Count profiles by type to verify completeness
SELECT 
  user_type,
  COUNT(*) as total_count,
  COUNT(CASE WHEN user_type = 'vendedor' AND store_name IS NOT NULL AND store_category IS NOT NULL AND store_description IS NOT NULL AND store_opening_hours IS NOT NULL AND store_whatsapp IS NOT NULL THEN 1 END) as complete_vendors,
